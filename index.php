...
<body class="hold-transition login-page dark-mode">
    ...
    <?php
     include "classes/Branch.php";
        ...
        $pass = $_POST["pass"];
        $branch = new Branch;
        echo $branch->loginSystem($manager,$br_id,$pass);
        ...
        <div class="card card-outline card-primary">
            ...
            <div class="card-body">
                ...
                <form method="POST" action="">
                    ...
                    <div class="input-group mb-3">
                        <input type="text" name="br_id" class="br_id form-control" placeholder="Brance Id">
                        <div class="input-group-append">
                            <div class="input-group-text">
                    ...
                    <div class="row">
                        ...
                        <!-- /.col -->
                        <div class="col-4">
                            <button type="submit" name="singIn" class="singIn btn btn-primary btn-block">Sign
                                In</button>
                        </div>
                        <!-- /.col -->
                    </div>
